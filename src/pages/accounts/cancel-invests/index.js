...
import useCancelInvestmentsColumns from '../../../hooks/columns/useCancelInvestmentsColumns';
...
function CancelInvests({ path }) {
	...
	const columns = useCancelInvestmentsColumns({
		actions: [
			{
				icon: 'TickSquare',
	...
	return (
		<>
			<h1 className={'pageTitle'}>Cancel invests</h1>
