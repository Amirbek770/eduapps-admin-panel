...
import useWithdrawsColumns from '../../../hooks/columns/useWithdrawsColumns';
...
function Withdraws({ path }) {
	...
	const columns = useWithdrawsColumns({
		actions: [
			{
				icon: 'TickSquare',
	...
	return (
		<>
			<h1 className={'pageTitle'}>Withdraws</h1>
